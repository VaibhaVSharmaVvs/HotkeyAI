...
/// </summary>
/// <remarks>
/// Security review 2026-08-17, finding L8. <c>LevelOf</c> computed
...
/// the structure.
/// <para>
/// Neither can happen for a SID the kernel wrote, which is why it survived: reaching it means memory
/// that is already wrong. The value it produced was the problem — a plausible-looking integer that
/// <c>IsHigherThanUs</c> would compare against High and answer confidently.
/// </para>
/// </remarks>
public sealed class IntegritySidTests
{
    ...
    {
        // The header is eight bytes: revision, sub-authority count, and six of identifier authority.
        // Any offset the function accepts must be at or past the end of it, or the value read is not
        // a sub-authority at all.
